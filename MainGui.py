...
class MainWindow(QWidget): #This class handles creating the GUI
    def __init__(self):
        ...
        pattern_size_label.setStyleSheet("font-size: 24px; color: black") 
        ...
        load_file_label = QLabel("Load From File:")
        load_file_label.setStyleSheet("font-size: 24px; color: black")
        h_box2.addWidget(load_file_label)
        self.modules_input = QLineEdit()
        self.modules_input.setStyleSheet("border: 2px solid #4FE0DD; background: white; color: black; font-size: 18px")
        ...
        self.TCP_input.setStyleSheet("background-color: #4FE0DD; font-size: 16px; color: black")
        ...
        for i in range(4):
            ...
            temp_checkbox.setStyleSheet("font-size: 24px; color: black")
            ...
            port_option.setStyleSheet("border: 2px solid #4FE0DD; background: white; color: black; font-size: 18px")
        ...
        rate_label.setStyleSheet("font-size: 18px; color: black")
        hb3vb2_h_box1.addWidget(rate_label)
        self.rate_input = QSpinBox()
        self.rate_input.setRange(1,999)
        self.rate_input.setValue(10)
        self.rate_input.setStyleSheet("border: 2px solid #4FE0DD; background: white; color: black; font-size: 18px")
